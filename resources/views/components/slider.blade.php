<div class="slider col-12">
    <div class="container">
        <div class="col-12 col-md-12 col-lg-5">
            ...
            <div class="actions">
                <a href="{{ route('new_shelter') }}" class="btn btn-primary btn-lg">Crear página web</a>
                <a href="#features" class="btn btn-outline-success btn-lg">Saber más</a>
            </div>
        </div>
    </div>
</div>